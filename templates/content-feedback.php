...
<div class="wedoc-feedback-wrap well">
    ...
    ?>
    <a href="#" class="tip positive" data-id="<?php the_ID(); ?>" data-type="positive" title="<?php echo esc_attr( $positive_title ); ?>"><i class="fa fa-check-square-o"></i> <?php echo __( 'Yes', 'wedocs' ); ?></a>
    <a href="#" class="tip negative" data-id="<?php the_ID(); ?>" data-type="negative" title="<?php echo esc_attr( $negative_title ); ?>"><i class="fa fa-times"></i> <?php echo __( 'No', 'wedocs' ); ?></a>
</div>
